...
class _Page2State extends State<Page2> {
                ...
                child: TableCalendar(
                  ...
                  onDaySelected: (selectedDay, focusedDay) {
                    setState(() {
                      ...
                      DateTime dateOnly = DateTime(selectedDay.year, selectedDay
  ...
  Widget _buildIconButton(Widget iconWidget, String iconType, Color color,
      Function onPressed) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selectedIcon == iconType ? color.withOpacity(0.2) : Colors
              .transparent,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text('${formatCurrency(totalIncome_Status)} THB',
          ...
          Row(
            ...
            children: [
              ...
              Text('${formatCurrency(totalExpense_Status)} THB',
    ...
    return TextButton(
      ...
      child: Text(
        ...
        style: TextStyle(
          ...
          fontWeight: selectedButton == label ? FontWeight.bold : FontWeight
              .normal, // เพิ่มความหนาของตัวอักษรเมื่อถูกเลือก
        ),
      ),
  ...
  void _showEditExpenseDialog(int id, Function(double, String) onSave) {
    ...
    var expense = selectedDateExpenses.firstWhere((
        expense) => expense['ID_transaction_Primary'] == id);
